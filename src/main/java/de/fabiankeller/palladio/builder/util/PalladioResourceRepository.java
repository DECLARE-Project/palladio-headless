...
public interface PalladioResourceRepository {
     ...
     * Hello stranger,
     * <p>
     * until there is a proper DI framework built into this project, we'll need to rely on this singleton to not have
     * to pass around the {@link PalladioResourceRepository} to all builders. Unfortunately, some deeply nested builders
     * require the resource repository and bubbling up the dependency leads to more technical debt than this singleton.
     * <p>
